...
$sel=$con->prepare("SELECT id as id_place, latitud, longitud FROM puntos p where name='Barefoot Park' and categories='All Categories' limit 1");
$sel->execute();
$res=$sel->get_result();
...
for ($x=0;$x<count($days); $x++){
    ...
    $sel=$con->prepare("INSERT INTO schedule(location_id,student_id,name,days,start_time,end_time,building,classroom)values('$location_id','$student_id','$name','$str_day','$start_time','$end_time','$building','$classroom')");

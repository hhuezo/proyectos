                    ...
                    <div class="col-md-12">
                        ...
                        <div class="border-0 mb-4">
                            <div
                                ...
                                <h4 class="fw-bold mb-0"> Modificar gráfico</h4>
                        ...
                        @endif
                        <div class="card-body">
                            <form id="basic-form" method="POST" action="{{ url('dashboard/update_grafica') }}">
                                @csrf
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <select name="tipo_grafica_id" required class="form-select">
                                                    <option value="1" {{$grafica->tipo_grafica_id == 1? 'selected':''}}>Barra</option>
                                                    {{-- <option value="2" {{$grafica->tipo_grafica_id == 2? 'selected':''}}>Pastel</option> --}}
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-6">
                                                <input type="text" name="titulo" value="{{$grafica->titulo}}" required class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="form-label col-md-3" align="right"><strong>Descripción para eje
                                                    Y</strong></label>
                                            <div class="col-6">
                                                <input type="text" name="descripcion" value="{{$grafica->descripcion}}" required class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>

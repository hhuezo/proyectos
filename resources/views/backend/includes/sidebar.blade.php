...
<div class="sidebar px-4 py-4 py-md-5 me-0">
    <div class="d-flex flex-column h-100">
        ...
        <ul class="menu-list flex-grow-1 mt-3">
            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'hr-dashboard' || Request::segment(2) == 'project-dashboard' ? 'active' : '' }}" href="{{ url('home') }}">
            ...
            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'hr-dashboard' || Request::segment(2) == 'project-dashboard' ? 'active' : '' }}" href="{{ url('load_unidades') }}">
            ...
            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'project' ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#project-Components2" href="#">
                    <i class="icofont-user"></i><span>Seguridad</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                <!-- Menu: Sub menu ul -->
                <ul class="sub-menu {{ Request::segment(2) == 'project' ? 'collapsed show' : 'collapse' }}" id="project-Components2">
                    <li><a class="ms-link {{ Request::segment(3) == 'index' ? 'active' : '' }}" href="{{ url('usuario') }}"><span>Usuario</span></a></li>
                    <li><a class="ms-link {{ Request::segment(3) == 'tasks' ? 'active' : '' }}" href="{{ url('rol') }}"><span>Roles </span></a></li>

                </ul>
            </li>

            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'project' ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#project-Components3" href="#">
                    <i class="icofont-ui-folder"></i><span>Catalogo</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                <!-- Menu: Sub menu ul -->
                <ul class="sub-menu {{ Request::segment(2) == 'project' ? 'collapsed show' : 'collapse' }}" id="project-Components3">
                    <li><a class="ms-link {{ Request::segment(3) == 'index' ? 'active' : '' }}" href="{{ url('unidad') }}"><span>Unidades</span></a></li>
                    <li><a class="ms-link {{ Request::segment(3) == 'index' ? 'active' : '' }}" href="{{ url('estado') }}"><span>Estados</span></a></li>
                    <li><a class="ms-link {{ Request::segment(3) == 'index' ? 'active' : '' }}" href="{{ url('categoria') }}"><span>Categorias</span></a></li>
                    <li><a class="ms-link {{ Request::segment(3) == 'index' ? 'active' : '' }}" href="{{ url('prioridad') }}"><span>Prioridades</span></a></li>
                    <li><a class="ms-link {{ Request::segment(3) == 'index' ? 'active' : '' }}" href="{{ url('catalogo/propietario') }}"><span>Propietario</span></a></li>
            ...
            <li class="collapsed">
                ...
                <ul class="sub-menu {{ Request::segment(2) == 'project' ? 'collapsed show' : 'collapse' }}" id="project-Components">
                    ...
                    <li><a class="ms-link {{ Request::segment(3) == 'tasks' ? 'active' : '' }}" href="{{ url('proyecto_finalizado') }}"><span>Finalizados </span></a></li>
            ...
            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'project' ? 'active' : '' }}" href="{{ url('actividades') }}">
                    <i class="icofont-list"></i><span>Actividades</span></a>
            </li>

            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'project' ? 'active' : '' }}" href="{{ url('actividades_finalizadas') }}">
            ...
            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'project' ? 'active' : '' }}" href="{{ url('actividades/1') }}">
            ...
            @if (auth()->user()->rol_id == 1)
            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'project' ? 'active' : '' }}" href="{{ url('facturar') }}">
            ...
            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'project' ? 'active' : '' }}" href="{{ url('iso/matriz_riesgo2022') }}">
            ...
            @if (auth()->user()->rol_id == 1 || auth()->user()->rol_id == 4)
            <li class="collapsed">
                <a class="m-link {{ Request::segment(2) == 'project' ? 'active' : '' }}" href="{{ url('actividades_coordinador') }}">
            ...
            <li class=" {{ Request::is('admin/auth/user') || Request::is('admin/auth/role') || Request::is('admin/auth/role/create') ? '' : ' collapsed' }}">
                <a class="m-link {{ Request::is('admin/auth/user') || Request::is('admin/auth/role') || Request::is('admin/auth/role/create') ? 'collapse show active' : '' }}{{ Request::is('admin/auth/role') ? 'collapse show active' : '' }}" data-bs-toggle="collapse" data-bs-target="#access" href="#"><i class="fa fa-lock"></i>
...
<div class="sidebar px-4 py-2 py-md-4 me-0">
    <div class="d-flex flex-column h-100">
        ...
        <ul class="menu-list flex-grow-1 mt-3">
            ...
            <li class="collapsed">
                <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-Authentication" href="#"><i class="icofont-ui-lock"></i> <span>Authentication</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                <!-- Menu: Sub menu ul -->
                <ul class="sub-menu collapse" id="menu-Authentication">
                    ...
                    <li><a class="ms-link" href="{{ route('admin.authentication.password-reset') }}"><span>Password
                                reset</span></a></li>
                    <li><a class="ms-link" href="{{ route('admin.authentication.two-step-authentication') }}"><span>2-Step
                                Authentication</span></a></li>
                    <li><a class="ms-link" href="{{ route('admin.authentication.bad-request') }}"><span>404</span></a></li>
                </ul>
            </li>
            <li><a class="m-link {{ Request::segment(3) == 'stater-page' ? 'active' : '' }}" href="{{ route('admin.ui-components.index') }}"><i class="icofont-code"></i> <span>Stater
                        page</span></a></li>
            <li class="{{ Request::segment(2) == 'ui-components' && Request::segment(3) != 'stater-page' ? '' : ' collapsed' }}">
                <a class="m-link {{ Request::segment(2) == 'ui-components' && Request::segment(3) != 'stater-page' ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#menu-Components" href="#"><i class="icofont-paint"></i> <span>UI Components</span> <span class="arrow icofont-dotted-down ms-auto text-end fs-5"></span></a>
                <!-- Menu: Sub menu ul -->

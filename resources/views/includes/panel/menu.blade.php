...
rol_id==2 analista  -->
    ...
    @if (auth()->user()->rol_id==1 || auth()->user()->rol_id==4) 
        ...
        @if (auth()->user()->unidadId() > 1 && (auth()->user()->rol_id == 1 || auth()->user()->rol_id == 4)) 
            <li class="nav-item dropdown">
                <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="ni ni-books text-orange"></i>CATALOGOS  
                </a>
        ...
        @if (auth()->user()->unidadId()==1 && auth()->user()->rol_id==1)  
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                    ...
                    <a href="{{URL::action('Admin\IsoMatrizController@iso2022')}}" class="dropdown-item">
                        <i class="ni ni-settings-gear-65"></i>
                        <span>Documentos 2022</span>
                    </a>

                    <a href="https://proyectos.em.com.sv/pivoteTable/" target="_blank" class="dropdown-item">
                        <i class="ni ni-settings-gear-65"></i>
                        <span>Pivote table</span>
                    </a>
    ...
    @if (auth()->user()->rol_id==2) 
        ...
        <li class="nav-item">
            <a class="nav-link"href="{{URL::action('Admin\IsoMatrizController@iso2022')}}">
                <i class="ni ni-bullet-list-67 text-red"></i> ISO 2022
            </a>
            </li>

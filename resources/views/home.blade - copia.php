  ...
  <link rel="stylesheet" href="{{ asset('assets/css/app.css')  }}  ">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12 col-lg-3 col-xl-3 col-xxl-3">
                            ...
                            <div class="card ">
                                ...
                                <div class="card-body" onclick="modal_actividades_finalizadas(0,'detalle')">
                        ...
                        <div class="col-md-12 col-lg-3 col-xl-3 col-xxl-3">
                            <div class="card ">
                                <div class="card-body"  onclick="modal_actividades_finalizadas(1,'detalle')">
                                    <div class="d-flex align-items-center">
    ...
    @if (auth()->user()->unidad_id == 1)
        ...
        @foreach ($graficas as $grafica)
            <div class="tab-pane fade show active" style="display: {{ $visibility }}" id="nav-dashboard"
                role="tabpanel">
    ...
    <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto"
        id="modal-actividades-finalizadas2" tabindex="-1" aria-labelledby="modal-actividades-finalizadas2"
            ...
            <div
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                    ...
                    <div
                        ...
                        <h3 class="text-xl font-medium text-black dark:text-black capitalize">
                            Favor, Ingrese su correo electronico
                        </h3>
                        ...
                        <button type="button"
                          ...
                          dark:hover:bg-slate-600 dark:hover:text-black"
        ...
        function get_actividades_finalizadas(id, control) {
            ...
            $.get("{{ url('get_actividades_finalizadas') }}" + '/' + id, function(data) {
                ...
                for (var i = 0; i < data.length ; i++) {
                    html = html + "<tr class='even:bg-slate-50 dark:even:bg-slate-700'><td class='table-td'>" + (i + 1) +"</td><td class='table-td'>" +

                    ...
                    <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                        ...
                        <form class="row g-1 p-0 p-4" method="post" action="{{ route('login') }}">
                            ...
                            <div class="col-12 text-center mb-5">
                                ...
                                <span class="d-flex justify-content-center text-secondary">User : jaime</span>
                                <span class="d-flex justify-content-center text-secondary">Password : jaime123</span>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="user_name" class="form-control form-control-lg" placeholder="someuser">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-2">

<div style="text-align: center">
    ...
    <div class="body d-flex py-lg-3 py-md-2">
                    ...
                    <tbody>
                        @foreach ($prioridades as $prioridad)
                            <tr>
                                ...
                                <td>{{ $prioridad->color }}</td>
                                <td>
                                    <button type="button" class="btn btn-success"><i class="icofont-edit  fa-lg"
                                            data-bs-toggle="modal" wire:click="edit({{ $prioridad->id }})"
                                            data-bs-target="#edit_prioridad"></i></button>
                                </td>
                            </tr>
                        @endforeach
        ...
        <div id="create_prioridad" wire:ignore.self class="modal fade" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header col">
                        <h5 class="modal-title  fw-bold" id="createprojectlLabel"> Nueva prioridad</h5>
        ...
        <div id="edit_prioridad" wire:ignore.self class="modal fade" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header col">
                        <h5 class="modal-title  fw-bold" id="createprojectlLabel"> Editar prioridad</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
        ...
        bottom: 0px;">
            ...
            <button class="botonF1" wire:click="create()" data-bs-toggle="modal" data-bs-target="#create_prioridad"
                style=" width: 60px;
        height: 60px;
        border-radius: 100%;
        background: #484c7f;
    ...
    <script type="text/javascript">
        ...
        window.addEventListener('close-modal', (e) => {
            $('#create_prioridad').modal('hide')
        });


        window.addEventListener('close-modal-edit', (e) => {
            $('#edit_prioridad').modal('hide')
        });
    </script>
</div>

                                                    ...
                                                    <div class="tikit-info row g-3 align-items-center">
                                                        <div class="col-sm">
                                                            <ul
                                                                ...
                                                                <li>
                                                                    <div class="d-flex align-items-center" wire:click="load_actividad({{ $actividad->id }})"
                        ...
                        <tbody>
                            @foreach ($actividades as $actividad)
                                <tr>
                                    ...
                                    <td>
                                        <div class="progress" style="height: 20px;"  wire:click="load_actividad({{ $actividad->id }})"  @if ($actividad->estado_id == 3) onclick="modal_avance()" @endif >
                    ...
                    <div class="modal-body row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="Operatividad Diaria" readonly>
                            </div>
                        </div>

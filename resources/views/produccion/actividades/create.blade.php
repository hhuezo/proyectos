                ...
                <div class="border-0 mb-4">
                    <div class="card-header py-3 no-bg bg-transparent d-flex px-0  border-bottom flex-wrap">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="text-align: right;">
                            <a href="{{url('actividades')}}"><button class="btn btn-primary float-right"><i class="fa fa-arrow-left"></i></button></a>
                        </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                                <div class="form-group">
                                    <label class="form-label"><strong>Ticket</strong></label>
                                        ...
                                        <input type="number" name="numero_ticket" value="0" class="form-control"
                                            required>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                                <div class="form-group">
                                    <label class="form-label"><strong>Ponderacion</strong></label>
                                        ...
                                        <input type="number" name="numero_ticket" value="0.01" class="form-control"
                                            readonly>
                        ...
                        <div class="row g-3 taskboard">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="text" value="NO APLICA" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">

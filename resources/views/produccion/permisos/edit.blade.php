                    ...
                    <div class="col-md-12">
                        ...
                        <div class="border-0 mb-4">
                            <div
                                ...
                                <h4 class="fw-bold mb-0"> Permiso Editar</h4>
                                <div class="col-auto d-flex w-sm-100">
                                    <a href="{{ url('produccion/permisos') }}">
                        ...
                        @endif
                          ...
                          <form id="basic-form" method="POST"   action="{{ route('permisos.update', $permissions->id) }}">
                            @method('PUT')
                            @csrf
                            <!-- Modal body -->
                            <div class="p-6 space-y-4">
                                <div class="input-area">
                                    ...
                                    <input type="text" class="form-control" required id="name" name="name" value="{{ $permissions->name }}">
                                </div>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-12">

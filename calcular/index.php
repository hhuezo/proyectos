...
//$sel=$con->prepare("SELECT a.id FROM actividades a LEFT OUTER JOIN proyectos p ON a.proyecto_id=p.id where a.tiempo_desarrollo is null and  a.proyecto_id='$proyecto_id'");
$sel=$con->prepare("SELECT a.id FROM actividades a where proyecto_id not in(9,11) and tiempo_desarrollo is null and numero_ticket<>'1234'");
...
<table>
  ...
  <?php while ($row = $res->fetch_assoc()) {
	...
	//   $objCon_sel->Abrir();
	  ...
	  $sql="CALL spCalculaTiempoMovimientoActividadesSinInicio(".$row['id'].");";
